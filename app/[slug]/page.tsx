...
export function generateStaticParams() {
  return entries.map(([, page]) => ({ slug: page.slug }));
}
...
function ServicesOverview() {
  return (
    <div className="problem-grid" aria-label="Vue d’ensemble des offres">
      ...
      <article className="problem-card">
        ...
        <p>Maintenance, visibilité locale ou pilotage de l’acquisition après la mise en ligne.</p>
...
export default async function ContentPage({ params }: PageProps) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: page.title, item: `/${slug}` },
    ],
  };
